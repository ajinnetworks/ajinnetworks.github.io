...
- [예지보전 도입 전 반드시 확인할 3가지]({% post_url 2026-05-21-예지보전-도입-전-반드시-확인할-3가지-방법-아진네트웍스 %})
- [모듈러·목조 생산 자동화 설계]({% post_url 2026-04-25-모듈러-주택-로봇-자동화-트렌드---아진네트웍스-기술-해설 %})

## 기술검토·RFQ 요청

예비견적 또는 ROI 검토 시 **현재 인원, 공정별 CT, 연간 생산량, 불량·재작업, 목표 CAPA, 자동화 범위, 설치공간, 허용 정지기간**을 제공하면 Preliminary BOM과 Conservative/Base/Upside 시나리오를 구성할 수 있습니다.
