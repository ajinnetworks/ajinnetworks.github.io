...
- [반도체 AOI 불량검출과 딥러닝 비전]({% post_url 2026-03-30-반도체-AOI-불량검출-딥러닝-비전으로-해결한-아진네트웍스 %})
- [2차전지 비전검사 도입 전 필수 체크리스트]({% post_url 2026-07-23-2차전지-비전검사-도입-전-필수-체크리스트-아진네트웍스 %})

## 기술검토·RFQ 요청

비전 RFQ에는 **제품 Sample, 최소 결함 크기, FOV, 표면 재질, 이동속도, 목표 Cycle, 허용 오검/미검 기준, 설치공간, PLC/MES 인터페이스**를 포함하면 광학 PoC 범위를 빠르게 정의할 수 있습니다.
